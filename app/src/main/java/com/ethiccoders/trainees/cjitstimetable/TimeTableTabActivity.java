...
public class TimeTableTabActivity extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 0:
                    return getApplicationContext().getString(R.string.mon_short);
                case 1:
                    return "Tue";
                case 2:
                    return "Wed";
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_timetable_list, container, false);
            ListView mListView = (ListView) rootView.findViewById(R.id.listView);

            int dayNum = Integer.parseInt(String.valueOf(getArguments().get(ARG_SECTION_NUMBER)));
            String daySel = "Monday";
            switch(dayNum) {
                case 2: daySel = "Tuesday"; break;
                case 3: daySel = "Wednesday"; break;
                case 4: daySel = "Thursday"; break;
                case 5: daySel = "Friday"; break;
                case 6: daySel = "Saturday"; break;
            }
            Cursor  cursor = DatabaseManager.getInstance().getPeriods(daySel);
            if(null!=cursor) {
                churchesCursorAdapter = new PeriodCursorAdapter(getContext(), cursor, true);
